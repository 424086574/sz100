...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_203671288";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "黑马程序员";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI4FyjVDhKC6dSs35pXbUu"; //你的AccessKey ID
	private static final String SECRET_KEY="mDHm87mMHdudZs3TcAdG30QTCM5mlx"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
		SMSUtils.sendShortMessage(VALIDATE_CODE,"17316177423","123456");
	}
